...
public class UserPrivilageController implements Serializable {
    ...
    private TreeNode createTreeNode() {
        ...
        TreeNode node2204=new PrivilageNode("Add or Remove Summeries", node22, Privileges.CashTransactionAddOrRemoveSummery);
        
        TreeNode node2205=new PrivilageNode("Search", node22);
        TreeNode node2205a=new PrivilageNode("Search Menu", node2205, Privileges.CashTransactionSearch);
        TreeNode node2205b=new PrivilageNode("Search Cash In", node2205, Privileges.CashTransactionSearchCashIn);
        TreeNode node2205c=new PrivilageNode("Search Cash Out", node2205, Privileges.CashTransactionSearchCashOut);
        TreeNode node2205d=new PrivilageNode("Search Hand Over", node2205, Privileges.CashTransactionSearchHandOverSearch);
        TreeNode node2205e=new PrivilageNode("Search Hand Over Approve", node2205, Privileges.CashTransactionSearchHandOverApprove);
        
        TreeNode node2206=new PrivilageNode("Adjustement", node22);
        TreeNode node2206a=new PrivilageNode("Adjustement Menu", node2206, Privileges.CashTransactionAdjustment);
        TreeNode node2206b=new PrivilageNode("Adjustement Cash", node2206, Privileges.CashTransactionAdjustmentCash);
        TreeNode node2206c=new PrivilageNode("Adjustement Card", node2206, Privileges.CashTransactionAdjustmentCard);
        TreeNode node2206d=new PrivilageNode("Adjustement Cheque", node2206, Privileges.CashTransactionAdjustmentCheque);
        TreeNode node2206e=new PrivilageNode("Adjustement Slip", node2206, Privileges.CashTransactionAdjustmentSlip);
        TreeNode node2206f=new PrivilageNode("Adjustement IOU", node2206, Privileges.CashTransactionAdjustmentIOU);
        TreeNode node2206g=new PrivilageNode("Adjustement Short", node2206, Privileges.CashTransactionAdjustmentShort);
        TreeNode node2206h=new PrivilageNode("Adjustement Credit", node2206, Privileges.CashTransactionAdjustmentCredit);
        TreeNode node2206i=new PrivilageNode("Adjustement Cash Book", node2206, Privileges.CashTransactionAdjustmentCashBook);
        TreeNode node2206j=new PrivilageNode("Adjustement Search", node2206, Privileges.CashTransactionAdjustmentSearch);
        
        TreeNode node2207=new PrivilageNode("Reports", node22);
        TreeNode node2207a=new PrivilageNode("Reports Menu", node2207, Privileges.CashTransactionReport);
        TreeNode node2207b=new PrivilageNode("Drawer", node2207, Privileges.CashTransactionReportDrawer);
        TreeNode node2207c=new PrivilageNode("History", node2207, Privileges.CashTransactionReportHistory);
        TreeNode node2207d=new PrivilageNode("Cash Not Recive", node2207, Privileges.CashTransactionReportCashNotReceive);
        TreeNode node2207e=new PrivilageNode("Cash Book", node2207, Privileges.CashTransactionReportCashBook);
        TreeNode node2207f=new PrivilageNode("Change User in History", node2207, Privileges.CashTransactionReportChangeUser);
        
        TreeNode node2208=new PrivilageNode("Administration", node22);
        TreeNode node2208a=new PrivilageNode("Administration Menu", node2208, Privileges.CashTransactionAdministration);
        TreeNode node2208b=new PrivilageNode("Settle Item", node2208, Privileges.CashTransactionAdministrationSettleItem);
        TreeNode node2208c=new PrivilageNode("Summery Item", node2208, Privileges.CashTransactionAdministrationSummeryItem);
        TreeNode node2208d=new PrivilageNode("Search All", node2208, Privileges.CashTransactionAdministrationSearchAll);
        TreeNode node2208e=new PrivilageNode("Search Without Users", node2208, Privileges.CashTransactionAdministrationSearchWithOutUser);
        TreeNode node2208f=new PrivilageNode("Edit Hand Over Item", node2208, Privileges.CashTransactionAdministrationEditHandoverItem);
        
        TreeNode node2209=new PrivilageNode("Hand Over", node22, Privileges.CashTransactionSearchHandOver);
