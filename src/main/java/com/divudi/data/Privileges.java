...
public enum Privileges {
    ...
    CashTransactionAddOrRemoveSummery,
    CashTransactionHandOver,
    CashTransactionSearch,
    CashTransactionSearchCashIn,
    CashTransactionSearchCashOut,
    CashTransactionSearchHandOverSearch,
    CashTransactionSearchHandOverApprove,
    CashTransactionAdjustment,
    CashTransactionAdjustmentCash,
    CashTransactionAdjustmentCheque,
    CashTransactionAdjustmentCredit,
    CashTransactionAdjustmentCard,
    CashTransactionAdjustmentSlip,
    CashTransactionAdjustmentIOU,
    CashTransactionAdjustmentShort,
    CashTransactionAdjustmentCashBook,
    CashTransactionAdjustmentSearch,
    CashTransactionReport,
    CashTransactionReportDrawer,
    CashTransactionReportHistory,
    CashTransactionReportCashNotReceive,
    CashTransactionReportCashBook,
