...
//    @Transient
    ...
    public void copy(BillItem billItem) {
        ...
        fromTime=billItem.getFromTime();
        toTime=billItem.getToTime();
...
//    }
    ...
    public void setHandOvered(boolean handOvered) {
    ...
    public WebUser getSettler() {
        return settler;
    }

    public void setSettler(WebUser settler) {
