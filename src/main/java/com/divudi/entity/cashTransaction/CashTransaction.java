...
///////////////////
    ...
    Double iouValue;
    Double shortValue;
    Double cashierShortValue;
    Double cashierExcessValue;
    ...
    public void copyQty(CashTransaction cashTransaction) {
        ...
        creditValue = cashTransaction.getCreditValue();
        iouValue = cashTransaction.getIouValue();
        cashierExcessValue = cashTransaction.getCashierExcessValue();
        cashierShortValue = cashTransaction.getCashierShortValue();
    ...
    public void invertQty(CashTransaction cashTransaction) {
        ...
        if (cashTransaction.getShortValue() != null) {
            shortValue = 0 - cashTransaction.getShortValue();
        }
        if (cashTransaction.getCashierExcessValue() != null) {
            cashierExcessValue = 0 - cashTransaction.getCashierExcessValue();
        }
        if (cashTransaction.getCashierShortValue() != null) {
            cashierShortValue = 0 - cashTransaction.getCashierShortValue();
        }
    ...
    public void setDrawerTransactions(WebUser loggedUser) {
        if (loggedUser==null || loggedUser.getDrawer()==null) {
            return ;
        }
        this.setCashValue(loggedUser.getDrawer().getRunningBallance());
        this.setCreditValue(loggedUser.getDrawer().getCreditBallance());
        this.setCreditCardValue(loggedUser.getDrawer().getCreditCardBallance());
        this.setChequeValue(loggedUser.getDrawer().getChequeBallance());
        this.setSlipValue(loggedUser.getDrawer().getSlipBallance());
        this.setIouValue(loggedUser.getDrawer().getIouBallance());
    }
    ...
    public Double getCashierShortValue() {
        if (cashierShortValue==null) {
            cashierShortValue=0.0;
        }
        return cashierShortValue;
    }

    public void setCashierShortValue(Double cashierShortValue) {
        this.cashierShortValue = cashierShortValue;
    }

    public Double getCashierExcessValue() {
        if (cashierExcessValue==null) {
            cashierExcessValue=0.0;
        }
        return cashierExcessValue;
    }
