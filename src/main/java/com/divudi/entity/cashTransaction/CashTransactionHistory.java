...
public class CashTransactionHistory implements Serializable {
    ...
    private double creditBallance;
    private double iouBallance;
    private double shortBallance;
    private double CashierShortBallance;
    private double CashierExcessBallance;
    ...
    public double getCreditBallance() {
        return creditBallance;
    }

    public void setCreditBallance(double creditBallance) {
        this.creditBallance = creditBallance;
    }

    public double getIouBallance() {
        return iouBallance;
    }

    public void setIouBallance(double iouBallance) {
        this.iouBallance = iouBallance;
    }

    public double getShortBallance() {
        return shortBallance;
    }

    public void setShortBallance(double shortBallance) {
        this.shortBallance = shortBallance;
    }
    ...
    public double getCashierShortBallance() {
        return CashierShortBallance;
    }

    public void setCashierShortBallance(double CashierShortBallance) {
        this.CashierShortBallance = CashierShortBallance;
    }

    public double getCashierExcessBallance() {
        return CashierExcessBallance;
    }

    public void setCashierExcessBallance(double CashierExcessBallance) {
        this.CashierExcessBallance = CashierExcessBallance;
    }
